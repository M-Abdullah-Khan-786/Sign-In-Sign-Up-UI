...
const SignIn = () => {
  ...
  return (
    <section>
      <div className="flex flex-col rounded-full items-center justify-center px-6 py-8 mx-auto md:h-screen lg:py-0">
        <a
          href="/"
          className="flex items-center mb-6 text-2xl font-semibold text-gray-900 dark:text-white"
        >
          <img className="w-8 h-8 mr-2" src={signIn} alt="logo" />
          Sign In
        </a>
